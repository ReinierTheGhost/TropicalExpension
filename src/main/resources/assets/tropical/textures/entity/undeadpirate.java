...
public class skeleton - Converted<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "skeleton_- converted"), "main");
	...
	public skeleton - Converted(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headwear_r1 = headwear.addOrReplaceChild("headwear_r1", CubeListBuilder.create().texOffs(52, -6).addBox(0.0F, -3.0F, 0.0F, 0.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.0F, 4.0F, -0.6485F, -0.3189F, 0.2333F));

		PartDefinition headwear_r2 = headwear.addOrReplaceChild("headwear_r2", CubeListBuilder.create().texOffs(52, -6).addBox(0.0F, -3.0F, 0.0F, 0.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.0F, 4.0F, -0.6578F, 0.3535F, -0.2613F));
